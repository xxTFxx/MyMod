...
public class ContainerSimpleGenerator extends Container{
	...
	private int energy , burnTime , totalBurnTime;
	
	public ContainerSimpleGenerator(InventoryPlayer player , TileEntitySimpleGenerator tileentity) {
	...
	public void detectAndSendChanges() {
		...
		this.totalBurnTime = this.tileentity.getField(2);*/
	}
